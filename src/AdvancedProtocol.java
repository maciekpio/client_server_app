...
public class AdvancedProtocol extends Protocol {
    public String advanced_processInput(String theInput, Map<Integer, HashSet<String>> map) {
        ...
        long server_time = serverEnd-serverStart;

        synchronized (MultiServer.syn_server_time) {MultiServer.server_time.add(server_time);}
